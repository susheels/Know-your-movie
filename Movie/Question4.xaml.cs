...
namespace Movie
{
    public partial class Question4 : PhoneApplicationPage
    {
        ...
        void OnTimerTick(Object sender, EventArgs args)
        {
            ...
            if (counter < 0)
            {
                newTimer.Stop();
                counter = 6;
                NavigationService.Navigate(new Uri("/Question5.xaml", UriKind.Relative));
            }
            else if (counter > 0)
            {
            ...
            {
                Op4.Fill.Opacity = 100;
                Op4.Fill = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.Green);
                clock.Text = "0";
            }
        }
