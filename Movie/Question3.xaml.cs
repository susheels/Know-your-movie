...
namespace Movie
{
    public partial class Question3 : PhoneApplicationPage
    {
        ...
        void OnTimerTick(Object sender, EventArgs args)
        {
            ...
            if (counter < 0)
            {
                newTimer.Stop();
                counter = 6;
                NavigationService.Navigate(new Uri("/Question4.xaml", UriKind.Relative));
            }
            else if (counter > 0)
            {
            ...
            {
                Op3.Fill.Opacity = 100;
                Op3.Fill = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.Green);
                clock.Text = "0";
            }
        }
